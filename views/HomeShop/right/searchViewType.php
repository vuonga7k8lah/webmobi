...
?>
    <div class="content">
        ...
        <div class="right">
            <?php
            if (HomeShopModel::searchType($id)->num_rows > 0) {
                $search = HomeShopModel::searchType($id)->fetch_all();
                ?>
                <p style="text-align:center;color:#e10c00;padding:10px">Loại Sản Phẩm:<?= $search[0][0] ?>
                <hr/>
                </p>
